...
\begin{itemize}
	...
	\item GitLab permite elegir miembros del equipo como revisores de ``merge requests".
	...
	\item Ambos permiten la integración con repositorios Maven
\end{itemize}
...
\subsection{Métricas de control: medición de la evolución o proceso de software}
...
\subsection{Framework de medición}
