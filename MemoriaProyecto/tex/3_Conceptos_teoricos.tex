...
\begin{itemize}
	...
	\item \textbf{Fuente de medición}: Proyecto en una plataforma de desarrollo colaborativo.
	\item \textbf{Interpretación}: $DEPUC \geq 0$. Cúanto más alto, más tiempo lleva en desarrollo el proyecto. En procesos software empresariales se debería comparar con la estimación temporal de la fase de planificación. 
	\item \textbf{Tipo de escala}: Absoluta
...
En la Fig. \ref{fig:MCTMotorMetricas} se muestra el diagrama de clases UML que identifica los conceptos principales del framework de medición y la relación entre ellos, especificando la navegabilidad y la multiplicidad. Las anotaciones en forma de flecha especifican los patrones de diseño aplicados en el framework \citep{gamma_patrones_2002}.
