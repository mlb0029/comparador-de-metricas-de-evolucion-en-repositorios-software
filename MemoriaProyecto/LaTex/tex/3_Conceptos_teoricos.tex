...
\imagen{M3_CI-CD}{CI/CD con GitLab \citep{gitlab_gitlab_nodate}}
...
Sommerville enumera en \textit{Ingeniería del software} \citep{sommerville_ingenierisoftware_2002} los principales factores que afectan a la calidad del producto, como se puede observar en la Fig. \ref{fig:M3-FactoresCalidad}:
\begin{itemize}
	\tightlist
...
\imagen{M3_CalidadProcesos}{Calidad basada en procesos \citep{sommerville_ingenierisoftware_2002}}
...
\imagen{M3-MetricasProcesoYProducto}{Métricas de control y métricas de predicción \citep{sommerville_ingenierisoftware_2002}}
